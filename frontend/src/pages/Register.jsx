...
.auth-card { background: rgba(30, 41, 59, 0.8); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); padding: 44px; border-radius: 20px; border: 1px solid rgba(99, 102, 241, 0.3); box-shadow: 0 20px 60px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(99, 102, 241, 0.1); width: 100%; max-width: 460px; animation: fadeInUp 0.6s ease-out; }
...
.auth-select { width: 100%; padding: 13px 14px; margin-bottom: 16px; border: 1px solid #334155; border-radius: 10px; font-size: 1rem; background: #0f172a; color: #f1f5f9; box-sizing: border-box; transition: border-color 0.3s ease, box-shadow 0.3s ease; outline: none; cursor: pointer; }
.auth-select:focus { border-color: #6366f1; box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.2); }
